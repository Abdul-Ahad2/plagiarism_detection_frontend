      ...
      <div className="h-auto bg-gradient-to-r from-black to-gray-900 text-gray-300 py-44">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            matches, repeated patterns, and suspicious keyword usage. This
            analysis highlights surface-level similarities, making it easier to
            spot direct copying or unusual repetition in student submissions.
          </p>
