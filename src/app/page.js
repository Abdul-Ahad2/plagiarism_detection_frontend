  ...
  return (
    <>
      ...
      <div className="w-full lg:h-[85vh] flex flex-col lg:flex-row bg-[#E4E4E4]">
        ...
        <div className="w-full lg:w-1/2 lg:m-1 order-first lg:order-none">
          <Image
      ...
      <div className="w-full lg:h-[85vh] bg-[#E4E4E4] flex justify-center p-4 md:p-6 lg:p-8">
        <div className="w-full max-w-8xl mx-auto grid grid-cols-1 lg:grid-cols-[1fr_auto_1fr_auto_1fr] items-center gap-6 lg:gap-8">
          {/* Upload Box */}
          <div className="bg-[#044343] h-[20rem] md:h-[25rem] lg:h-[28rem] w-full aspect-[4/5] border-black border-b-4 border-l-4 md:border-b-6 md:border-l-6 lg:border-b-8 lg:border-l-8 border-r-2 border-t-2 text-[#E4E4E4] flex items-center justify-center rounded-3xl lg:rounded-4xl">
      ...
      <div className="p-1 bg-[#E4E4E4]">
        <div className="w-full lg:h-[85vh] bg-[#044343] flex justify-center rounded-sm">
          <div className="w-full lg:w-1/2 h-full p-4 md:p-6 lg:p-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 grid-rows-4 md:grid-rows-2 lg:grid-rows-2 gap-3 md:gap-4 lg:gap-2">
            {/* TF-IDF Box */}
            <div className="bg-[#E4E4E4] flex items-center justify-center border-black border-l-4 md:border-l-6 lg:border-l-8 border-b-4 md:border-b-6 lg:border-b-8 border-r-2 border-t-2 rounded-2xl md:rounded-3xl lg:rounded-[2rem] aspect-square w-full h-full">
      ...
      <div className="w-full lg:h-[85vh] bg-[#E4E4E4] flex justify-center items-center py-8 lg:py-0">
        <div className="flex flex-col items-center space-y-6 md:space-y-8 lg:space-y-12 w-full px-4 md:px-8 lg:px-0">
          {/* Locked Tight */}
          <div className="w-full md:w-4/5 lg:w-3/5 h-auto md:h-[15vh] lg:h-[20vh] border-[#044343] border-b-4 border-l-4 md:border-b-6 md:border-l-6 lg:border-b-8 lg:border-l-8 flex items-center justify-center  lg:rounded-5xl p-4 md:p-6">
            <h1
              className={`${dmSans_lighter.className} text-lg md:text-xl lg:text-3xl text-[#044343] text-center md:text-left`}
            >
              <span
                className={`${dmSans_light.className} text-xl md:text-2xl lg:text-4xl block md:inline`}
              >
                Locked Tight
              </span>
